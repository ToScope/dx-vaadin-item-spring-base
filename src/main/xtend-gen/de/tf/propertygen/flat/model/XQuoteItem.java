...
import de.tf.propertygen.flat.model.XQuote;
...
/**
 * <h1>Generated Class, Don't Change!</h1><br>For modifying open XQuote.java <br>null
 */
@DItem
@MetaModelOf(value = "de.tf.propertygen.flat.model.XQuote")
@Generated(value = "ditem.processor.DItem")
@SuppressWarnings("all")
public class XQuoteItem extends AbstractBeanItemBase<XQuote> implements Serializable {
  ...
  public XQuoteItem(final XQuote bean) {
    super(bean);
